...
class GraphEncoder(object):
    def __init__(self, word_vocab=None, edge_label_vocab=None, char_vocab=None, POS_vocab = None, is_training=True, options=None):
        ...
        self.passage_nodes_POS_size = tf.placeholder(tf.int32, [None, None])
        self.passage_nodes_POS = tf.placeholder(tf.int32, [None, None, None])
        ...
        passage_nodes_POS_size_max = tf.shape(self.passage_nodes_POS)[2]
        ...
        passage_nodes_POS_representation = tf.reshape(passage_nodes_POS_representation,
                                                        shape=[batch_size * passage_nodes_size_max,
                                                               passage_nodes_POS_size_max, POS_dim])
