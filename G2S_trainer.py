...
def main(_):
    ...
    for file in train_files:
        ...
        if file.split('.')[-1] == 'json':
            ...
            trainset_amr, trn_node, trn_in_neigh, trn_out_neigh, trn_sent = G2S_data_stream.read_amr_file(file)
            ...
            trainset_rdf, trn_node, trn_in_neigh, trn_out_neigh, trn_sent = G2S_data_stream.read_rdf_file(file)
            ...
            trainset_tmp, trn_node, trn_in_neigh, trn_out_neigh, trn_sent = (None, 0, 0, 0, 0)
    ...
    for file in dev_files:
        ...
        if file.split('.')[-1] == 'json':
            ...
            devset_amr, tst_node, tst_in_neigh, tst_out_neigh, tst_sent = G2S_data_stream.read_amr_file(file)
            ...
            devset_rdf, tst_node, tst_in_neigh, tst_out_neigh, tst_sent = G2S_data_stream.read_rdf_file(file)
            ...
            devset_tmp, trn_node, trn_in_neigh, trn_out_neigh, trn_sent = (None, 0, 0, 0, 0)
    ...
    if FLAGS.finetune_path != "":
        ...
        for file in fintune_files:
            ...
            if file.split('.')[-1] == 'json':
                ...
                ftset_amr, ft_node, ft_in_neigh, ft_out_neigh, ft_sent = G2S_data_stream.read_amr_file(file)
                ...
                ftset_rdf, ft_node, ft_in_neigh, ft_out_neigh, ft_sent = G2S_data_stream.read_rdf_file(file)
                ...
                ftset_tmp, trn_node, trn_in_neigh, trn_out_neigh, trn_sent = (None, 0, 0, 0, 0)
    ...
    if os.path.exists(best_path + ".index"):
        ...
        POS_vocab = Vocab(voc=['amr', 'rdf'], dim=FLAGS.POS_dim, fileformat='build')
    ...
    trainDataStream = G2S_data_stream.G2SDataStream(trainset, word_vocab, char_vocab, edgelabel_vocab, POS_vocab, options=FLAGS,
                 isShuffle=True, isLoop=True, isSort=True)

    devDataStream = G2S_data_stream.G2SDataStream(devset, word_vocab, char_vocab, edgelabel_vocab, POS_vocab, options=FLAGS,
    ...
    if ftset != None:
        ftDataStream = G2S_data_stream.G2SDataStream(ftset, word_vocab, char_vocab, edgelabel_vocab, POS_vocab, options=FLAGS,
                 isShuffle=True, isLoop=True, isSort=True)
        ...
        with tf.name_scope("Train"):
            with tf.variable_scope("Model", reuse=None, initializer=initializer):
                train_graph = ModelGraph(word_vocab=word_vocab, Edgelabel_vocab=edgelabel_vocab,
                                         char_vocab=char_vocab, POS_vocab=POS_vocab, options=FLAGS, mode=FLAGS.mode)
        ...
        with tf.name_scope("Valid"):
            with tf.variable_scope("Model", reuse=True, initializer=initializer):
                valid_graph = ModelGraph(word_vocab=word_vocab, Edgelabel_vocab=edgelabel_vocab,
                                         char_vocab=char_vocab, POS_vocab=POS_vocab, options=FLAGS, mode=valid_mode)
