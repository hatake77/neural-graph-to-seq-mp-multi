...
class ModelGraph(object):
    def __init__(self, word_vocab, char_vocab, Edgelabel_vocab, POS_vocab, options=None, mode='ce_train'):
        ...
        self.nodes = self.encoder.passage_nodes # word embeddings
        self.nodes_num = self.encoder.passage_nodes_size
        self.nodes_POS = self.encoder.passage_nodes_POS # word embeddings
        self.nodes_POS_num = self.encoder.passage_nodes_POS_size
        ...
        with variable_scope.variable_scope("generator"):
            ...
            # calculate encoder_features [batch_size, passage_len, encoder_dim] --> [batch_size, passage_len, options.attention_vec_size]
    ...
    def run_encoder(self, sess, batch, options, only_feed_dict=False):
        ...
        feed_dict[self.nodes_POS] = batch.node_POS
        feed_dict[self.nodes_POS_num] = batch.node_POS_num
